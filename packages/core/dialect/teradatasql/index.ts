 ...
 */
import TeradataSQLLib from 'teradata-nodejsdriver';


export default class TeradataSQL extends GenericDialect<TeradataSQLLib.Connection> implements ConnectionDialect {
  ...
  private get lib() {
    return __non_webpack_require__('teradata-nodejsdriver');
  }
